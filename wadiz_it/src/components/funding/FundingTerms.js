      ...
      <Segment style={{padding:"30px"}}>
        <Form>
          <Form.Group widths="equal">
            <Form.TextArea
              style={{
                height: 200, lineHeight: "2.2rem", resize: "none", paddingLeft: "30px", paddingRight: "30px",
                backgroundColor: "rgb(245, 245, 245)", border:"rgb(245, 245, 245)"}}
              fluid="true"
          ...
          <div style={{ display: "inline-block", marginBottom:"20px" }}>
            <label id="check" htmlFor="check" style={{display:"inline", marginRight:"5px"}}></label>
          ...
          <Form.Group widths="equal">
            <Form.TextArea
              style={{
                height: 200, resize: "none", lineHeight: "2.2rem", paddingLeft: "30px", paddingRight: "35px",
                backgroundColor: "rgb(245, 245, 245)", border: "rgb(245, 245, 245)"}}
              fluid="true"
              label="개인정보 수집 및 이용 동의"
              required={true}
          ...
          <div style={{display: "inline-block"}}>
            <label id="check2" htmlFor="check2" style={{display:"inline", marginRight:"5px"}}></label>
