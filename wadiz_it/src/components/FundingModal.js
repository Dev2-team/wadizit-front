...
const FundingModal = (props) => {
    ...
    const setPaymentPoint = () => {
        ...
        if (paymentPoint < memberData.point) {
            setCkPoint(false);
            document.getElementById("afterPoint").innerText = memberData.point - paymentPoint;
            ...
            {open ? (
                <div className='modalSection'>
                    <div className='modalHeader'>
                        {header} 
                        <button className='modalClose' onClick={close}>x</button>
                    </div>
                    <div className='modalMain'>
                        ...
                        <div>
                            ...
                            <div>결제 포인트</div>
                            <input type="number" id="inputPoint" onKeyUp={setPaymentPoint}></input>
                            <div>최종결제 포인트</div>
